...
class DrawingView: UIView {
    ...
    private var blockColor: CGColor = UIColor(red: 0.0, green: 100 / 255, blue: 0.3, alpha: 0.12)
        .cgColor
    private var lineColor: CGColor = UIColor(red: 0.7, green: 0.0, blue: 0.3, alpha: 0.18).cgColor
    private var elementColor: CGColor = UIColor(red: 0.3, green: 0.0, blue: 0.9, alpha: 0.23)
        .cgColor
        ...
        for block in blocks {
            ...
            for line in lines {
                ...
                for element in elements {
                    ...
                    drawRect(
                        ctx: ctx, rect: element.frame * (frameSize / imageSize), color: elementColor
                    )

                    let text = element.text

                    text.draw(
                        at: element.frame.origin * (frameSize / imageSize),
